...
from calpha.utils_strategy import get_yf_data
import numpy as np
    ...
    for symbol in symbols:
        try:
            ...
            if symbol not in already_existing_symbols:
                ...
                # Shift features by 1 day: entry day uses previous day's indicator values
                # (the trade opens on the close of the signal day, so today's indicators aren't yet known)
                df = df_price.shift(1).join(df, how='right')
